...
export const ALL_NODE_TYPES: NodeType[] = [
  'service', 'database', 'server', 'client', 'storage', 'api', 'text', 'subflow', 'sticky',
  'process-requirements', 'process-design', 'process-development', 'process-testing',
  'process-deployment', 'process-monitoring',
  'gcp-cloud-run', 'gcp-cloud-storage', 'gcp-bigquery', 'gcp-pub-sub', 'gcp-apigee',
  'gcp-billing', 'gcp-cloud-build', 'gcp-cloud-monitoring', 'gcp-cloud-sql',
  'gcp-compute-engine', 'gcp-iam', 'gcp-kubernetes', 'gcp-security',
  ...
  'proglang-python', 'proglang-ruby', 'proglang-swift', 'proglang-typescript',
  'proglang-javascript', 'proglang-vala', 'proglang-vyper', 'proglang-zig',
