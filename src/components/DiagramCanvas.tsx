...
const defaultNodeLabels: Record<NodeType, string> = {
  ...
  'proglang-apl': 'APL',
  'proglang-ballerina': 'Ballerina',
  'proglang-c': 'C',
  'proglang-clojure': 'Clojure',
  'proglang-clojurescript': 'ClojureScript',
  'proglang-cpp': 'C++',
  'proglang-csharp': 'C#',
  'proglang-erlang': 'Erlang',
  'proglang-fsharp': 'F#',
  'proglang-go': 'Go',
  'proglang-haskell': 'Haskell',
  'proglang-jule': 'Jule',
  'proglang-nim': 'Nim',
  'proglang-objectivec': 'Objective-C',
  'proglang-perl': 'Perl',
  'proglang-purescript': 'PureScript',
...
export const DiagramCanvas = () => {
  ...
  const nodeTypes = useMemo(() => ({
    ...
    'proglang-apl': BaseNode,
    'proglang-ballerina': BaseNode,
    'proglang-c': BaseNode,
    'proglang-clojure': BaseNode,
    'proglang-clojurescript': BaseNode,
    'proglang-cpp': BaseNode,
    'proglang-csharp': BaseNode,
    'proglang-erlang': BaseNode,
    'proglang-fsharp': BaseNode,
    'proglang-go': BaseNode,
    'proglang-haskell': BaseNode,
    'proglang-jule': BaseNode,
    'proglang-nim': BaseNode,
    'proglang-objectivec': BaseNode,
    'proglang-perl': BaseNode,
    'proglang-purescript': BaseNode,
