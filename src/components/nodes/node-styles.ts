...
export const nodeTypeStyles: Record<NodeType, NodeStyle> = {
  ...
  "shape-round-rectangle": { bg: "bg-violet-100/20", border: "border-violet-300/50", icon: "text-violet-600" },
  "shape-diamond": { bg: "bg-orange-100/20", border: "border-orange-300/50", icon: "text-orange-600" },
  "shape-arrow-rectangle": { bg: "bg-cyan-100/20", border: "border-cyan-300/50", icon: "text-cyan-600" },
  "shape-cylinder": { bg: "bg-emerald-100/20", border: "border-emerald-300/50", icon: "text-emerald-600" },
  "shape-parallelogram": { bg: "bg-purple-100/20", border: "border-purple-300/50", icon: "text-purple-600" },
  "shape-plus": { bg: "bg-red-100/20", border: "border-red-300/50", icon: "text-red-600" },
  "shape-triangle": { bg: "bg-amber-100/20", border: "border-amber-300/50", icon: "text-amber-600" },
